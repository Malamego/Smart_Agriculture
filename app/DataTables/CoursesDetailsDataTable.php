...
class CoursesDetailsDataTable extends DataTable
{
    ...
    {
        $query = CoursesDetail::query()->with('course_relation', 'class_relation')->select('courses_details.*');
    ...
    protected function getColumns()
    {
        return [
             ...
             [
                 'name' => "courses_details.showdate",
                 'data'    => 'showdate',
                 'title'   => trans('main.showdate'),
                 'searchable' => true,
                 'orderable'  => true,
                 'width'          => '100px',
             ],
             [
                 'name' => "courses_details.status",
                 'data'    => 'status',
    ...
    {
        return 'courses_details_' . date('YmdHis');
    }
}
